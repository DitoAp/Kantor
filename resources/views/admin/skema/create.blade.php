...
<div class="container-fluid p-0" style="max-width: 800px;">
    <div class="mb-4">
        ...
        <h4 class="fw-bold text-dark m-0 mt-2">Tambah Skema Sertifikasi Baru</h4>
    </div>
        ...
        <form action="{{ route('admin.skema.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_skema" class="form-control rounded-3 @error('kode_skema') is-invalid @enderror" placeholder="Contoh: SKM/01/LSP-GSP/2026" value="{{ old('kode_skema') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="jenis" class="form-control rounded-3 @error('jenis') is-invalid @enderror" placeholder="Contoh: Okupasi, KKNI, atau Klaster" value="{{ old('jenis') }}">
                    @error('jenis') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-12">
                    <label class="form-label fw-bold text-dark">Nama Judul Skema Sertifikasi</label>
                    <input type="text" name="nama_skema" class="form-control rounded-3 @error('nama_skema') is-invalid @enderror" placeholder="Contoh: Food & Beverage Captain" value="{{ old('nama_skema') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_unit" class="form-control rounded-3 @error('jumlah_unit') is-invalid @enderror" placeholder="0" value="{{ old('jumlah_unit') }}">
            ...
            <div class="d-flex justify-content-end gap-2 border-top pt-4 mt-5">
                ...
                <button type="submit" class="btn btn-dark-premium rounded-3"><i class="fa-solid fa-floppy-disk me-2"></i> Simpan Skema</button>
            </div>
        </form>
    </div>
</div>
